		...
		let list = [
			{
				id:'id1',
				name:'OnePlus5',
				desc:'Powerful, smooth and fast. Experience the power and smoothness of our top flagship - OnePlus 5 with Dual camera, Snapdragon™ 835, 8GB RAM',
			...
			},
			{
				id:'id2',
				name:'iphone8',
				desc:'iPhone 8 and iPhone 8 Plus are smartphones designed, developed, and marketed by Apple Inc',
			...
			{
				name:'id3',
				desc:'iPhone X smartphone designed, developed, and marketed by Apple Inc',
				imageUrl:'https://i.amz.mshcdn.com/zQ5EORq3gRLBzlFRKDbSYb4VATA=/fit-in/1200x9600/https%3A%2F%2Fblueprint-api-production.s3.amazonaws.com%2Fuploads%2Fcard%2Fimage%2F595423%2Fb3763d14-9f7d-4dbe-9f17-926316b6bdf5.jpg',
				price:70000
			},
		]

		dispatch({type:"FETCH_LIST_FULLFILLED",payload:list})
	/*	axios({
			method:'POST',
